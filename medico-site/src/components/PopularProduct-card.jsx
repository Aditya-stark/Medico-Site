...
export default function PopularProductCard({ image, title, rating, price, offer }) {
  ...
  return (
    <div className="card bg-white rounded-lg shadow-lg p-4 relative overflow-hidden transform transition-transform duration-300 hover:scale-105 hover:shadow-2xl">
      ...
      {/* Product All Details */}
      <div className="mt-4">
        <h3 className="text-gray-800 text-lg font-bold overflow-hidden text-ellipsis">{title}</h3>
        ...
        {/* Cart Button */}
        <button className="w-10 h-10 bg-teal-500 text-white rounded-full absolute bottom-4 right-4 shadow-md hover:bg-teal-600 transform transition-transform duration-300 hover:scale-110">
